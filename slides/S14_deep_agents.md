...
content:
  ...
  body_html: |
    <style>
      .s14.anexo-slide .body { top: 280px !important; bottom: 100px !important; overflow: visible !important; }
      .s14 { padding-top: 0; }
      .s14 .top-row { display: grid; grid-template-columns: 1fr auto; column-gap: 64px; align-items: center; margin-bottom: 36px; }
      .s14 .stages { display: flex; flex-direction: column; gap: 4px; }
      .s14 .stage { display: grid; grid-template-columns: 320px 70px auto; align-items: baseline; padding: 4px 0; }
      .s14 .stage .k { font-family: var(--sans); font-size: 25px; font-weight: 500; color: var(--ink); }
      .s14 .stage .arrow { font-family: var(--mono); font-size: 22px; color: var(--rule); }
      .s14 .stage .v { font-family: var(--sans); font-size: 25px; color: var(--ink); }
      .s14 .callout { border: 1px solid var(--coral); padding: 28px 32px; max-width: 400px; text-align: center; font-size: 24px; font-weight: 600; color: var(--ink); line-height: 1.35; }
      .s14 .closing { font-size: 18px; color: var(--ink); line-height: 1.55; max-width: 900px; }
