...
content:
  ...
  body_html: |
    <style>
      .s03.anexo-slide .body { top: 300px !important; bottom: 100px !important; overflow: visible !important; }
      .s03-topo { display: grid; grid-template-columns: 1fr 1px 1fr; gap: 60px; align-items: stretch; padding-top: 0; }
      .s03-topo .divider-v { background: var(--rule); width: 1px; height: 380px; align-self: center; }
      .s03-topo .col { padding: 0 16px; display: flex; flex-direction: column; align-items: flex-start; }
      .s03-topo .h { font-family: var(--mono); font-size: 22px; font-weight: 700; color: var(--ink); margin-bottom: 24px; }
      .s03-topo .diag { display: flex; justify-content: center; align-items: center; width: 100%; min-height: 260px; margin-bottom: 24px; }
      .s03-topo .diag svg { width: 100%; max-width: 500px; height: auto; }
      .s03-topo .sub { font-size: 22px; font-weight: 500; color: var(--ink); align-self: center; text-align: center; max-width: 540px; line-height: 1.35; }
      .s03-topo .sub-coral { font-size: 17px; font-weight: 500; color: var(--coral); align-self: center; text-align: center; max-width: 560px; line-height: 1.4; margin-top: 10px; }
    </style>
    <div class="s03-topo">
      <div class="col">
