...
content:
  ...
  body_html: |
    <style>
      .s23.anexo-slide .body { top: 270px !important; bottom: 80px !important; overflow: visible !important; }
      .s23 { padding-top: 0; }
      .s23 .timeline { display: flex; justify-content: center; padding: 24px 0 0 0; }
      .s23 .timeline-grid { display: grid; grid-template-columns: repeat(5, 1fr); width: 1240px; column-gap: 0; position: relative; }
      .s23 .timeline-line { position: absolute; top: 14px; left: 10%; right: 10%; height: 1px; background: var(--ink); z-index: 0; }
      .s23 .col { display: flex; flex-direction: column; align-items: center; text-align: center; position: relative; z-index: 1; padding: 0 6px; }
      .s23 .cap-dot { width: 14px; height: 14px; border-radius: 50%; background: var(--ink); margin-bottom: 18px; }
      .s23 .col.coral .cap-dot { background: var(--coral); width: 18px; height: 18px; margin-bottom: 16px; }
      .s23 .name { font-family: var(--mono); font-size: 17px; font-weight: 700; color: var(--ink); letter-spacing: 0.02em; margin-bottom: 4px; }
      .s23 .verb { font-family: var(--mono); font-size: 15px; color: var(--mute); margin-bottom: 22px; letter-spacing: 0.02em; }
      .s23 .eq { font-family: var(--mono); font-size: 15px; color: var(--ink); line-height: 1.55; min-height: 72px; }
      .s23 .eq em { font-style: italic; color: var(--mute); }
      .s23 .nomen { margin-top: 36px; padding-top: 18px; border-top: 1px solid var(--rule); display: flex; justify-content: center; }
      .s23 .nomen-inner { width: 1240px; }
      .s23 .nomen-h { font-family: var(--mono); font-size: 13px; font-weight: 700; color: var(--ink); letter-spacing: 0.1em; text-transform: uppercase; margin-bottom: 10px; }
      .s23 .nomen-body { font-family: var(--mono); font-size: 13.5px; color: var(--mute); line-height: 1.75; }
      .s23 .nomen-body strong { color: var(--ink); font-weight: 700; }
      .s23 .nomen-body .phase { display: inline-block; min-width: 110px; color: var(--coral); font-weight: 700; }
    </style>
    <div class="s23">
      <div class="timeline">
