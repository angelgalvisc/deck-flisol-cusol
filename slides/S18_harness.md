...
content:
  ...
  body_html: |
    <style>
      .s18.anexo-slide .body { top: 220px !important; bottom: 90px !important; overflow: visible !important; }
      .body > .s18 { padding-top: 0; max-width: 1440px; display: flex; flex-direction: column; height: 100%; box-sizing: border-box; }
      .s18 .main-row { display: grid; grid-template-columns: 1fr 1.05fr; column-gap: 60px; align-items: start; }
      .s18 .components-label { font-size: 18px; color: var(--ink); margin-bottom: 16px; font-weight: 500; }
      .s18 .row { display: grid; grid-template-columns: 200px 1fr; gap: 20px; padding: 10px 0; align-items: baseline; }
      .s18 .row .k { font-family: var(--mono); font-size: 18px; font-weight: 700; color: var(--ink); letter-spacing: 0.04em; }
      .s18 .row .v { font-size: 18px; color: var(--ink); line-height: 1.4; }
      .s18 .defs { display: flex; flex-direction: column; gap: 12px; }
      .s18 .def { border-left: 2px solid var(--coral); padding: 6px 14px; }
      .s18 .def .src { font-family: var(--mono); font-size: 13px; font-weight: 700; color: var(--coral); letter-spacing: 0.12em; text-transform: uppercase; margin-bottom: 6px; }
      .s18 .def .q { font-size: 18px; font-style: italic; color: var(--ink); line-height: 1.4; }
      .s18 .closing { font-size: 22px; font-weight: 500; color: var(--ink); line-height: 1.4; margin-top: auto; padding-top: 20px; }
