...
content:
  ...
  body_html: |
    <style>
      .s06.anexo-slide .body { top: 320px !important; bottom: 100px !important; overflow: visible !important; }
      .s06 { padding-top: 0; }
      .s06 .cols { display: grid; grid-template-columns: 1fr 1px 1fr; gap: 28px; align-items: start; }
      .s06 .divider-v { background: var(--rule); width: 1px; height: 260px; }
      .s06 .col-h { font-family: var(--mono); font-size: 16px; font-weight: 700; color: var(--ink); margin-bottom: 10px; }
      .s06 .codebox { background: #F2F2F2; border-radius: 4px; padding: 14px 16px; font-family: var(--mono); font-size: 13px; color: var(--ink); line-height: 1.7; margin-bottom: 10px; white-space: pre-wrap; }
      .s06 .codebox .c { color: #4D8060; }
      .s06 .code-note { font-family: var(--mono); font-size: 13px; color: var(--ink-soft); margin-bottom: 12px; }
      .s06 .rule { height: 1px; background: var(--rule); margin: 16px 0; }
      .s06 .footer { font-size: 22px; font-weight: 400; color: var(--ink); line-height: 1.45; }
      .s06 .footer .mono { font-family: var(--mono); font-size: 20px; }
      .s06 .footer .coral-line { color: var(--coral); font-family: var(--mono); font-size: 20px; }
    </style>
    <div class="s06">
      <div class="cols">
        <div>
