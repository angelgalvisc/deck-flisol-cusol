...
content:
  ...
  body_html: |
    <style>
      .s28.anexo-slide .body { top: 240px !important; bottom: 70px !important; overflow: visible !important; }
      .body > .s28 { padding-top: 0; max-width: 1380px; font-family: var(--sans); }
      .s28 .row-h { display: grid; grid-template-columns: 180px 240px 1fr; column-gap: 28px; padding: 8px 0; font-family: var(--mono); font-size: 12px; font-weight: 700; color: var(--mute); letter-spacing: 0.1em; text-transform: uppercase; border-bottom: 1px solid var(--ink); }
      .s28 .row { display: grid; grid-template-columns: 180px 240px 1fr; column-gap: 28px; padding: 10px 0; align-items: baseline; border-bottom: 1px solid var(--rule); }
      .s28 .row:last-of-type { border-bottom: none; }
      .s28 .row .fase { font-family: var(--mono); font-size: 17px; font-weight: 700; color: var(--ink); letter-spacing: 0.02em; }
      .s28 .row .when { font-family: var(--mono); font-size: 13px; color: var(--mute); line-height: 1.4; }
      .s28 .row .when strong { color: var(--ink); font-weight: 700; }
      .s28 .row .idea { font-size: 17px; color: var(--ink); line-height: 1.4; font-weight: 400; }
      .s28 .row.coral .fase { color: var(--coral); }
      .s28 .row.coral .idea { color: var(--ink); font-weight: 500; }
      .s28 .row.coral .idea em { color: var(--coral); font-style: normal; font-weight: 600; }
      .s28 .refs { margin-top: 24px; padding-top: 16px; border-top: 1px solid var(--rule); }
      .s28 .refs-h { font-family: var(--mono); font-size: 11px; font-weight: 700; color: var(--mute); letter-spacing: 0.1em; text-transform: uppercase; margin-bottom: 10px; }
      .s28 .refs-list { font-family: var(--mono); font-size: 11px; color: var(--mute); line-height: 1.6; }
      .s28 .refs-list .ref { margin-bottom: 4px; }
      .s28 .refs-list .marker { color: var(--coral); font-weight: 700; margin-right: 8px; }
      .s28 .refs-list .url { color: var(--ink); }
      .s28 .row .marker-inline { color: var(--coral); font-weight: 700; font-family: var(--mono); font-size: 11px; vertical-align: super; margin-left: 4px; }
    </style>
    <div class="s28">
      <div class="row-h">
        <div>Fase</div>
      ...
      <div class="row">
        ...
        <div class="idea">entrenar pesos con <em>atención</em> · el modelo aprende a pesar qué tokens importan en cada contexto</div>
      </div>
      <div class="row">
