...
content:
  ...
  body_html: |
    <style>
      .s13.anexo-slide .body { top: 300px !important; bottom: 100px !important; overflow: visible !important; }
      .s13 { padding-top: 0; }
      .s13 .chart { display: flex; justify-content: center; padding: 24px 0; }
      .s13 .source { font-size: 13px; color: var(--mute); margin-top: 24px; font-family: var(--mono); }
      .s13 .source em { font-style: italic; }
    </style>
    <div class="s13">
      <div class="chart">
