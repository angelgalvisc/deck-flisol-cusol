...
content:
  ...
  body_html: |
    <style>
      .s09.anexo-slide .body { top: 240px !important; bottom: 70px !important; overflow: visible !important; }
      .body > .s09 { padding-top: 0; max-width: 1380px; font-family: var(--sans); }
      .s09 .row-h { display: grid; grid-template-columns: 180px 240px 1fr; column-gap: 28px; padding: 8px 0; font-family: var(--mono); font-size: 12px; font-weight: 700; color: var(--mute); letter-spacing: 0.1em; text-transform: uppercase; border-bottom: 1px solid var(--ink); }
      .s09 .row { display: grid; grid-template-columns: 180px 240px 1fr; column-gap: 28px; padding: 10px 0; align-items: baseline; border-bottom: 1px solid var(--rule); }
      .s09 .row:last-of-type { border-bottom: none; }
      .s09 .row .fase { font-family: var(--mono); font-size: 17px; font-weight: 700; color: var(--ink); letter-spacing: 0.02em; }
      .s09 .row .when { font-family: var(--mono); font-size: 13px; color: var(--mute); line-height: 1.4; }
      .s09 .row .when strong { color: var(--ink); font-weight: 700; }
      .s09 .row .idea { font-size: 17px; color: var(--ink); line-height: 1.4; font-weight: 400; }
      .s09 .row.coral .fase { color: var(--coral); }
      .s09 .row.coral .idea { color: var(--ink); font-weight: 500; }
      .s09 .row.coral .idea em { color: var(--coral); font-style: normal; font-weight: 600; }
      .s09 .refs { margin-top: 24px; padding-top: 16px; border-top: 1px solid var(--rule); }
      .s09 .refs-h { font-family: var(--mono); font-size: 11px; font-weight: 700; color: var(--mute); letter-spacing: 0.1em; text-transform: uppercase; margin-bottom: 10px; }
      .s09 .refs-list { font-family: var(--mono); font-size: 11px; color: var(--mute); line-height: 1.6; }
      .s09 .refs-list .ref { margin-bottom: 4px; }
      .s09 .refs-list .marker { color: var(--coral); font-weight: 700; margin-right: 8px; }
      .s09 .refs-list .url { color: var(--ink); }
      .s09 .row .marker-inline { color: var(--coral); font-weight: 700; font-family: var(--mono); font-size: 11px; vertical-align: super; margin-left: 4px; }
    </style>
    <div class="s09">
      <div class="row-h">
        <div>Fase</div>
...
Tabla compañera del timeline (S07). Mientras S07 muestra la estructura formal (ecuaciones), S08 muestra el arco histórico — cuándo se acuñó cada disciplina, quién y dónde está la referencia primaria.
