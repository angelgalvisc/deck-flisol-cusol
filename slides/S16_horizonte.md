...
content:
  ...
  body_html: |
    <style>
      .s16.anexo-slide .body { top: 230px !important; bottom: 90px !important; overflow: visible !important; }
      .body > .s16 { padding-top: 0; display: flex; flex-direction: column; font-family: var(--sans); }
      .s16 .chart { display: flex; justify-content: center; }
      .s16 .chart svg { width: 1200px; max-width: 100%; height: auto; }
      .s16 .below { display: flex; flex-direction: column; gap: 12px; margin-top: 10px; }
      .s16 .row-1 { display: grid; grid-template-columns: 820px 1fr; gap: 40px; align-items: start; }
      .s16 .read-box { border-left: 2px solid var(--coral); padding: 10px 14px; }
      .s16 .read-box .h { font-family: var(--mono); font-size: 12px; font-weight: 700; color: var(--coral); letter-spacing: 0.1em; text-transform: uppercase; margin-bottom: 4px; }
      .s16 .read-box .b { font-size: 15px; color: var(--ink); line-height: 1.45; }
      .s16 .sources { font-family: var(--mono); font-size: 11px; color: var(--mute); line-height: 1.5; padding-top: 4px; }
      .s16 .sources .h { font-weight: 700; color: var(--mute); letter-spacing: 0.1em; text-transform: uppercase; margin-bottom: 4px; }
      .s16 .insight { font-size: 18px; font-weight: 500; color: var(--ink); line-height: 1.4; }
    </style>
    <div class="s16">
      <div class="chart">
