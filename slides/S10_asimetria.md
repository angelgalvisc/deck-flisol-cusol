...
content:
  ...
  body_html: |
    <style>
      .s10.anexo-slide .body { top: 300px !important; bottom: 100px !important; overflow: visible !important; }
      .s10 { padding-top: 0; }
      .s10 .chart { display: flex; justify-content: center; padding: 24px 0; }
      .s10 .source { font-size: 13px; color: var(--mute); margin-top: 24px; font-family: var(--mono); }
      .s10 .source em { font-style: italic; }
    </style>
    <div class="s10">
      <div class="chart">
