...
content:
  ...
  body_html: |
    <style>
      .s11.anexo-slide .body { top: 230px !important; bottom: 90px !important; overflow: visible !important; }
      .body > .s11 { padding-top: 0; max-width: 1400px; margin: 0 auto; display: flex; flex-direction: column; gap: 28px; }
      .s11 .grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 24px; align-items: start; }
      .s11 .cell { display: flex; flex-direction: column; align-items: center; text-align: center; padding: 14px 12px 18px; border: 1px solid var(--rule); border-radius: 6px; background: var(--bg); }
      .s11 .cell.coral { border: 2px solid var(--coral); padding: 13px 11px 17px; }
      .s11 .cell img { width: 100%; max-width: 200px; height: auto; display: block; mix-blend-mode: multiply; }
      .s11 .cell .k { font-family: var(--mono); font-size: 22px; font-weight: 700; color: var(--ink); letter-spacing: -0.005em; margin-top: 6px; }
      .s11 .cell.coral .k { color: var(--coral); }
      .s11 .cell .v { font-size: 24px; color: var(--mute); line-height: 1.3; margin-top: 8px; min-height: 90px; }
      .s11 .cell.coral .v { color: var(--ink); font-weight: 500; }
      .s11 .quote { font-size: 26px; font-weight: 400; color: var(--ink); font-style: italic; line-height: 1.5; max-width: 1280px; margin: 0 auto; text-align: center; }
      .s11 .quote .q { color: var(--coral); font-style: normal; }
      .s11 .cite { font-family: var(--mono); font-size: 12px; color: var(--mute); margin-top: 8px; text-align: center; }
    </style>
    <div class="s11">
      <div class="grid">
        <div class="cell">
