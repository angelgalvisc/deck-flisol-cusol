...
content:
  ...
  body_html: |
    <style>
      ...
      .s19 .layer .label { font-family: var(--mono); font-size: 14px; font-weight: 700; color: var(--ink); margin-bottom: 8px; text-align: center; letter-spacing: 0.04em; }
      .s19 .layer.outer .label { color: var(--coral); }
      .s19 .layer .content { font-size: 15px; color: var(--ink); line-height: 1.55; text-align: center; margin-bottom: 12px; }
      .s19 .layer.outer { width: 920px; }
