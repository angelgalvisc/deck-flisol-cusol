...
content:
  ...
  body_html: |
    <style>
      .s13.anexo-slide .body { top: 280px !important; bottom: 100px !important; overflow: visible !important; }
      .s13 { padding-top: 0; }
      .s13 .top-row { display: grid; grid-template-columns: 1fr auto; column-gap: 64px; align-items: center; margin-bottom: 36px; }
      .s13 .stages { display: flex; flex-direction: column; gap: 4px; }
      .s13 .stage { display: grid; grid-template-columns: 320px 70px auto; align-items: baseline; padding: 4px 0; }
      .s13 .stage .k { font-family: var(--sans); font-size: 25px; font-weight: 500; color: var(--ink); }
      .s13 .stage .arrow { font-family: var(--mono); font-size: 22px; color: var(--rule); }
      .s13 .stage .v { font-family: var(--sans); font-size: 25px; color: var(--ink); }
      .s13 .callout { border: 1px solid var(--coral); padding: 28px 32px; max-width: 400px; text-align: center; font-size: 24px; font-weight: 600; color: var(--ink); line-height: 1.35; }
      .s13 .closing { font-size: 18px; color: var(--ink); line-height: 1.55; max-width: 900px; }
      .s13 .closing .insight { color: var(--coral); }
    </style>
    <div class="s13">
      <div class="top-row">
        <div class="stages">
