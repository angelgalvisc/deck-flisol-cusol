...
content:
  ...
  body_html: |
    <style>
      .s11.anexo-slide .body { top: 320px !important; bottom: 100px !important; overflow: visible !important; }
      .s11 { padding-top: 0; }
      .s11 .cols { display: grid; grid-template-columns: 1fr 1px 1fr; gap: 28px; align-items: start; }
      .s11 .divider-v { background: var(--rule); width: 1px; height: 260px; }
      .s11 .col-h { font-family: var(--mono); font-size: 16px; font-weight: 700; color: var(--ink); margin-bottom: 10px; }
      .s11 .codebox { background: #F2F2F2; border-radius: 4px; padding: 14px 16px; font-family: var(--mono); font-size: 13px; color: var(--ink); line-height: 1.7; margin-bottom: 10px; white-space: pre-wrap; }
      .s11 .codebox .c { color: #4D8060; }
      .s11 .code-note { font-family: var(--mono); font-size: 13px; color: var(--ink-soft); margin-bottom: 12px; }
      .s11 .rule { height: 1px; background: var(--rule); margin: 16px 0; }
      .s11 .footer { font-size: 22px; font-weight: 400; color: var(--ink); line-height: 1.45; }
      .s11 .footer .mono { font-family: var(--mono); font-size: 20px; }
      .s11 .footer .coral-line { color: var(--coral); font-family: var(--mono); font-size: 20px; }
    </style>
    <div class="s11">
      <div class="cols">
        <div>
